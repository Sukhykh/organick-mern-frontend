            ...
            <div className={ styles.aboutSection__container }>
                <div className={ styles.aboutSection__wrapper }>
                    <div className={ styles.aboutSection__background }>
                        <picture>
                            <source srcSet={ backgroundWebp } type="image/webp" media="(min-width: 500px)"/>
                            <source srcSet={ backgroundWebpLittle } type="image/webp" media="(max-width: 500px)"/>
                            <img className={ styles.aboutSection__backgroundImg } src={backgroundPng} alt="about-picture" />
                        </picture>
                    </div>
                    <div className={ styles.aboutSection__contant }>
                        ...
                        <div className={ styles.aboutSection__cardWrapper }>
                            {aboutSectionData?.map(el => <AboutSectionCard data={el} key={el.id}/>) }
                        </div>
                        <SiteButton title="shop now" yellow={false} path="shop"/>
                    </div>
                </div>
            </div>
        </section>
