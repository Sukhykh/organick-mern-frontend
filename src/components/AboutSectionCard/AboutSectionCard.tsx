...
export const AboutSectionCard: React.FC<aboutSectionCardProps> = ({ data }) => {
    ...
    return (
        <div className={ styles.aboutSectioCard }>
            <div className={ `${styles.aboutSectioCard__imgWrapper} ${id % 2 === 0 ? styles.aboutSectioCard__imgWrapper_even : styles.aboutSectioCard__imgWrapper_odd }` }>
                <img className={ styles.aboutSectioCard__img } src={ picture } alt="icon" width={ 46 } height={ 46 } />
            </div>
