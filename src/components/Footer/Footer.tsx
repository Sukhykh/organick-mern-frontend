                ...
                <div className={ styles.footer__wrapper }>
                    <div className={ styles.footer__contactUs }>
                        ...
                        <ul className={ styles.footer__contactUsList }>
                            <li className={ styles.footer__contactUsItem }>
                                <a className={ styles.footer__contactUsLink } href="mailto:needhelp@Organia.com?subject=Contacts">
                                    <span className={ styles.footer__contactUsTitle }>email</span>
                                    <span className={ styles.footer__contactUsText }>needhelp@Organia.com</span>
                                </a>
                            </li>
                            <li className={ styles.footer__contactUsItem }>
                                <a className={ styles.footer__contactUsLink } href="tel:666888888">
                                    <span className={ styles.footer__contactUsTitle }>phone</span>
                                    <span className={ styles.footer__contactUsText }>666 888 888</span>
                                </a>
                            </li>
                            <li className={ styles.footer__contactUsItem }>
                                <a className={ styles.footer__contactUsLink } 
                                    ...
                                    <span className={ styles.footer__contactUsTitle }>address</span>
                                    <span className={ styles.footer__contactUsText }>88 road, Borklyn street, USA</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div className={ styles.footer__mainInfo }>
                        ...
                        <div className={ styles.footer__followBar }>
                            {followData?.map(el => <FollowItem data={ el } key={ el.id }/>)}
                        </div>
                    </div>
                    <div className={ styles.footer__utility }>
                    <h3 className={ styles.footer__title }>utility pages</h3>
                        <ul className={ styles.footer__utilityList } onClick={e => handleClick(e)}>
                            <li className={ styles.footer__utilityItem }>
                                <a className={ styles.footer__utilityLink } href="#">Style Guide</a>
                            </li>
                            <li className={ styles.footer__utilityItem }>
                                <a className={ styles.footer__utilityLink } href="#">404 Not Found</a>
                            </li>
                            <li className={ styles.footer__utilityItem }>
                                <a className={ styles.footer__utilityLink } href="#">Password Protected</a>
                            </li>
                            <li className={ styles.footer__utilityItem }>
                                <a className={ styles.footer__utilityLink } href="#">Licences</a>
                            </li>
                            <li className={ styles.footer__utilityItem }>
                                <a className={ styles.footer__utilityLink } href="#">Changelog</a>
                            </li>
                        </ul>
                    </div>
                </div>
