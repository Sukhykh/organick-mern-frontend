...
export const NewsForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            axiosBasic.post('/subscription', {user: form})
        ...
        <section className={ styles.newsForm }>
            <div className={ styles.newsForm__container }>
                <div className={ styles.newsForm__wrapper }>
                    <form className={ styles.newsForm__form } onSubmit={handleSubmit}>
                        <div className={ styles.newsForm__titleWrapper }>
                            <SectionTitle title='Subscribe to our Newsletter' black={ false } hero={ false }/>
                        </div>
                        <div className={ styles.newsForm__subscribe }>
                            <input className={ styles.newsForm__inputLine }
                                type="email" 
                                name="email" 
                                id="email" 
                                value={form}
                                ...
                                required/>
                            <input className={ styles.newsForm__inputSubmit } type="submit" value='Subscribe'/>
                            <div className={ styles.newsForm__alert }>{ responceData }</div>
                        </div>
                    </form> 
                </div>
            </div>
