        ...
        <div className={ styles.offerBannerCard }>
            <div className={ styles.offerBannerCard__imgWrapper } >
                <picture>
                    ...
                    <img className={ styles.offerBannerCard__img } src={ picture } alt="banner" width={ 682 } height={ 367 } />
                </picture>
            </div>
            <div className={ styles.offerBannerCard__textWrapper }>
                <Subtitle title={ subtitle } green={ colorWhite ? false : true }/>
                <h3 className={ colorWhite ? `${styles.offerBannerCard__title} ${styles.offerBannerCard__title_white}` : `${styles.offerBannerCard__title} ${styles.offerBannerCard__title_blue}` } >{title}</h3>
            </div>
        </div>
