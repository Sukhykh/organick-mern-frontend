            ...
            <section className={ styles.error }>
                <div className={ styles.error__background }>
                    <div className={ styles.error__imgWrapper }>
                        <picture>
                            <source srcSet={ pictureWebp } type="image/webp" media="(min-width: 500px)"/>
                            <source srcSet={ pictureWebpSmall } type="image/webp" media="(max-width: 500px)"/>
                            <img className={ styles.error__backgroundImg } src={ picturePng } alt="picture" width={1920} height={898}/>
                        </picture>
                    </div>
                    <div className={ styles.error__patternWrapper }>
                        <img className={ styles.error__backgroundImg } src={ pattern } alt="pattern" width={1920} height={898}/>
                    </div>
                </div>
                <div className={ styles.error__container }>
                    <div className={ styles.error__wrapper }>
                        <div className={ styles.error__content }>
                            ...
                            <p className={ styles.error__descr }>The page you are looking for doesn't exist or has been moved</p>
                            <SiteButton title='go to homepage' yellow={false} path='/'/>
                        </div>
                    </div>
                </div>
            </section>
